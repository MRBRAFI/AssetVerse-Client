        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div className="space-y-2">
            ...
            >
              ...
              <span className="text-xs font-black uppercase tracking-[0.3em]">Resource Acquisition</span>
            </motion.div>
            <motion.h1 
            ...
            >
              Request <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Assets</span>
            </motion.h1>
          ...
          >
             ...
             <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">Global Registry</span>
             <div className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" />
             <span className="text-sm font-black text-blue-600 leading-none">{assetsData.length} Items</span>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
            {filteredAndSortedAssets.length > 0 ? (
              ...
              >
                ...
                <h3 className="text-3xl font-black text-gray-900 uppercase tracking-tighter mb-2">No Matching Assets</h3>
                <p className="text-gray-400 font-bold uppercase text-xs tracking-[0.2em]">Refine your system search criteria</p>
              </motion.div>
            )}
          </div>
        </AnimatePresence>
