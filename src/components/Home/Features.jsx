  ...
  const features = [
    {
      ...
      description:
        "Live tracking of all assets across your entire organization with high precision.",
      color: "text-blue-500",
      bg: "bg-blue-50",
    },
    {
      ...
      description:
        "Enterprise-grade protection layer ensuring your data remains secure and compliant.",
    ...
    },
    {
      ...
      description:
        "Streamlined asset distribution system allowing management to assign resources efficiently.",
    ...
    },
    {
      ...
      title: "Employee Sync",
      description:
        "Automated user management and role-based access control for seamless onboarding.",
    ...
    },
    {
      ...
      description:
        "Powerful analytical tools providing insights into resource usage and lifecycle costs.",
    ...
    },
    {
      ...
      description:
        "A centralized directory for company assets, accessible from anywhere.",
      color: "text-rose-500",
      bg: "bg-rose-50",
    },
  ];
    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <Container>
        <div className="text-center mb-20">
          ...
          >
            Empowering modern businesses with efficient asset management
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div
                  className={`${feature.bg} ${feature.color} w-16 h-16 rounded-2xl flex items-center justify-center mb-8 shadow-sm group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500`}
                >
